...
FrameResource::FrameResource(ID3D12Device* pDevice, UINT uiPassCount, UINT uiObjectCount, UINT uiMaterialCount) : m_pxPassConstantBuffer(nullptr), m_pxObjectConstantBuffer(nullptr), m_pxCommandListAllocator(nullptr), m_ui64Fence(0)
{
